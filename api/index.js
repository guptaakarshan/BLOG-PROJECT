    ...
    const app = express();
    // const PORT = process.env.PORT || 5001; // REMOVE THIS LINE
    // Vercel handles ports internally for serverless functions,
    // but if you were to run this locally as a standalone function,
    // you might use a default port like 3000.
    // For Vercel deployment, this line is not strictly needed for port definition.
    ...
    // IMPORTANT: Export the app for Vercel to use as a serverless function
    module.exports = app;
